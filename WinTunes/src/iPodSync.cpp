...
#ifdef WINTUNES_NO_GPOD
iPodSync::iPodSync() = default;
iPodSync::~iPodSync() = default;
std::vector<std::string> iPodSync::detectMountPoints() { return {}; }
bool iPodSync::connect(const std::string&) {
    last_error_ = "iPod support is unavailable: libgpod was not found.";
    return false;
}
void iPodSync::disconnect() {}
iPodInfo iPodSync::getInfo() const { return {}; }
std::vector<Track> iPodSync::getIPodTracks() const { return {}; }
bool iPodSync::addTrack(const Track&, SyncProgressCallback) {
    last_error_ = "iPod support is unavailable: libgpod was not found.";
    return false;
}
bool iPodSync::removeTrack(const std::string&) {
    last_error_ = "iPod support is unavailable: libgpod was not found.";
    return false;
}
bool iPodSync::syncPlaylist(const std::string&, const std::vector<Track>&,
...
bool iPodSync::resetMusicDatabase(const std::string&) {
    last_error_ = "iPod support is unavailable: libgpod was not found.";
    return false;
}
#else
