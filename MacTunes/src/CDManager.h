...
public:
    ...
    // Rip one track and encode to target format. macOS supports AIFF/WAV/AAC/M4A;
    // Linux additionally supports the formats provided by its external tools.
    ...
    // Uses native drutil/afconvert on macOS, wodim/ffmpeg on Linux.
