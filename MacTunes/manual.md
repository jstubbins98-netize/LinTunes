...
optional: the script enables Internet Radio when `pkg-config` can find libVLC,
and otherwise continues the build with Internet Radio disabled:
...
| libVLC (optional) | Internet radio stream playback; must be visible to `pkg-config` |
