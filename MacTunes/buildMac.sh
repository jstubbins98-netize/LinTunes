...
if pkg-config --exists libvlc; then
  ...
  echo "VLC.app is installed, but its libVLC development files are not visible to pkg-config."
  echo "MacTunes will build without Internet Radio; local playback is unaffected."
else
