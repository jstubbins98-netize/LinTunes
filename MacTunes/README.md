...
CD access depends on libcdio availability and the optical drive exposed by
macOS. CD burning through the Linux `wodim` backend is intentionally disabled.
...
- **SQLite database** — persistent library at `~/.local/share/mactunes/library.db`
